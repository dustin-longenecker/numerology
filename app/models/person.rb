  ...
  def self.get_birth_path_num(birthdate)
    ...
    def self.get_message(birth_path_num)
      ...
      case birth_path_num
        ...
        else message = "Your numerology number is 3. Number Three is a sociable, friendly, and outgoing vibration. Kind, positive, and optimistic, Three's enjoy life and have a good sense of humor. Ruled by Jupiter."
      end
    end
